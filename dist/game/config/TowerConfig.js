...
exports.TowerConfig = exports.SIGNATURE_BOONS = void 0;
exports.SIGNATURE_BOONS = [
    {
...
class TowerConfig {
    static calculateEnemyStats(floor) {
    ...
    static roll3Boons() {
        const shuffled = [...exports.SIGNATURE_BOONS].sort(() => 0.5 - Math.random());
