...
exports.AreaBossService = exports.AREA_BOSSES = void 0;
...
class AreaBossService {
    /**
     * Đổi Tiền Đồng lấy Điểm Công Đức (100,000 Đồng = 1 Điểm Công Đức)
     */
    static async buyMeritPoints(userId, amount) {
        if (amount <= 0)
     ...
     */
    static async checkAndConsumeMeritForBoss(userId, area) {
        const boss = exports.AREA_BOSSES[area] || {
            area,
        ...
        const user = await User_model_1.UserModelAdvanced.findOne({ userId });
        if (!user)
            return { canChallenge: false, message: 'Không tìm thấy dữ liệu người chơi.' };
        ...
        // Trừ Điểm Công Đức
        await User_model_1.UserModelAdvanced.updateOne({ userId }, { $inc: { 'suDo.diemCongDuc': -boss.requiredMerit } });
        return {
            canChallenge: true,
            bossInfo: boss,
...
exports.AreaBossService = AreaBossService;
