...
class StatCalculationService {
    ...
    static calculateFullMatrix(user) {
        ...
        const combatPower = Math.floor(physicalAtk * 2.5 +
            physicalDef * 2.0 +
            totalMaxHp * 0.5 +
            critRate * 500 +
            critDmg * 300 +
...
exports.StatCalculationService = StatCalculationService;
