...
exports.suDoCommand = suDoCommand;
const User_model_1 = require("../../database/models/User.model");
const embedBuilder_1 = require("../../utils/embedBuilder");
async function suDoCommand(message, args) {
    ...
    if (subCmd === 'nhan') {
        ...
        const disciple = await User_model_1.UserModelAdvanced.findOne({ userId: targetUser.id });
        ...
        await User_model_1.UserModelAdvanced.updateOne({ userId }, { $push: { 'suDo.deTuIds': targetUser.id } });
        await User_model_1.UserModelAdvanced.updateOne({ userId: targetUser.id }, { $set: { 'suDo.suPhuId': userId } });
        const embed = (0, embedBuilder_1.createDongSonEmbed)()
            .setTitle('🤝 BÁI SƯ THÀNH CÔNG!')
            .setDescription(`**<@${targetUser.id}>** đã bái **<@${userId}>** làm Sư Phụ!\n\n` +
    ...
    const embed = (0, embedBuilder_1.createDongSonEmbed)()
        ...
        .setDescription(`Sư Phụ: ${user.suDo?.suPhuId ? `<@${user.suDo.suPhuId}>` : '*(Chưa bái sư)*'}\n` +
