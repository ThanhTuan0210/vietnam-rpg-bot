...
exports.luyenVoCommand = luyenVoCommand;
...
async function luyenVoCommand(message) {
    ...
    const cooldownCheck = CooldownEngine_1.CooldownEngine.checkCooldown(user, 'luyenvo', 60000);
    ...
    try {
        ...
        if (isCorrect) {
            ...
            await UserService_1.UserService.updateCooldownAtomic(userId, 'luyenvo', Date.now());
