...
export async function helpInteractiveCommand(message: Message): Promise<void> {
  const embed = createDongSonEmbed()
    .setTitle('📖 TRUNG TÂM TRA CỨU & GỢI Ý LỆNH — KYRISE RPG')
    .setDescription(
      `Chào mừng bạn đến với Vương Quốc Trung Cổ Medieval Kyrise!\n\n` +
...
export async function handleHelpSelectInteraction(interaction: StringSelectMenuInteraction): Promise<void> {
