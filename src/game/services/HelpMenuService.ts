...
export class HelpMenuService {
   ...
   */
  public static renderHelpEmbed(prefix = 'vn ') {
      ...
      .addFields(
        {
          ...
          value:
            `\`${p}profile\` (\`${p}p\`), \`${p}inventory\` (\`${p}inv\`), \`${p}cooldowns\` (\`${p}cd\`), ` +
        ...
        },
        {
          ...
          value:
            `\`${p}hunt\` (\`${p}h\`), \`${p}adventure\` (\`${p}adv\`), \`${p}heal\`, \`${p}duel\` (\`${p}pvp\`), ` +
        ...
        },
        {
          ...
          value:
            `\`${p}shop\`, \`${p}buy [qty] [item]\`, \`${p}sell all\`, \`${p}sell [item]\`, ` +
        ...
        },
        {
          ...
          value:
            `\`${p}dice\`, \`${p}blackjack\`, \`${p}slots\`, \`${p}roulette\`, \`${p}rps\`, \`${p}race\`, \`${p}baucua\``,
          inline: false,
        },
        {
          name: '🧗 Level Unlocked Mechanics',
          value:
            '**Level 1 - 9:** Wooden & Bamboo Equipment (`vn craft dao_tre_gai`)\n' +
