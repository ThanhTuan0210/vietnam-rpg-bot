import { ITowerActiveBuff, BoonType, BoonRarity } from '../../database/models/TowerSession.model';
...
export const BOON_CATALOG: BoonDefinition[] = [
  // Thường
  {
    buffId: 'boon_atk_1',
...
export class RoguelikeTowerEngine {
   ...
   */
  public static generateTowerEnemy(floor: number): TowerEnemy {
   ...
   */
  public static roll3Boons(): BoonDefinition[] {
    const shuffled = [...BOON_CATALOG].sort(() => 0.5 - Math.random());
